package com.avo.accounts.controller;
...
import com.avo.accounts.dto.ErrorResponseDto;
import com.avo.accounts.dto.ResponseDto;
...
@Validated
@Tag(
        name = "CRUD REST APIs for Accounts Microservice in Avo Bank",
        description = "CRUD REST APIs in Avo Bank to CREATE, FETCH, UPDATE and DELETE account details"
)
public class AccountsController {
    ...
    @Operation(
            ...
            description = "REST API to create new Customer & Account inside Avo Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
